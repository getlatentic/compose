/* @ts-self-types="./workspace_index_wasm.d.ts" */
 ...
 * @param {number} indexed_at_ms
 * @returns {string}
 */
export function buildIndex(workspace_id, docs_json, indexed_at_ms) {
    let deferred4_0;
    let deferred4_1;
    try {
        ...
        const ptr1 = passStringToWasm0(docs_json, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len1 = WASM_VECTOR_LEN;
        wasm.buildIndex(retptr, ptr0, len0, ptr1, len1, indexed_at_ms);
 ...
 * @returns {string}
 */
export function searchIndex(workspace_id, query, limit) {
    let deferred4_0;
    let deferred4_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        ...
        const len1 = WASM_VECTOR_LEN;
        wasm.searchIndex(retptr, ptr0, len0, ptr1, len1, limit);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        var r3 = getDataViewMemory0().getInt32(retptr + 4 * 3, true);
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./workspace_index_wasm_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('workspace_index_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
